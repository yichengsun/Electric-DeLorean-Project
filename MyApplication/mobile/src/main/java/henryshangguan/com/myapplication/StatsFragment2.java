...
public class StatsFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_stats_2, parent, false);
        ...
        mCardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment newFragment = DetailFragment.newInstance("zero");
        ...
        mCardView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment newFragment = DetailFragment.newInstance("hello");
                swapDetail(newFragment);
            }
        });
        ...
        mCardView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment newFragment = DetailFragment.newInstance("world");
                swapDetail(newFragment);
            }
        });
        return v;
